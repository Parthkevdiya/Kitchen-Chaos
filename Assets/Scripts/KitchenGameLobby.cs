...
public class KitchenGameLobby : MonoBehaviour
{
    ...
    public event EventHandler OnCreteLobbyStarted;
    public event EventHandler OnCreteLobbyFailed;
    ...
    {
        OnCreteLobbyStarted?.Invoke(this , EventArgs.Empty);
        try
        {
        ...
        {
            Debug.Log(e);
            OnCreteLobbyFailed?.Invoke(this , EventArgs.Empty);
        }
    }
