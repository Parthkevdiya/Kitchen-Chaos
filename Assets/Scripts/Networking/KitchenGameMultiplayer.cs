...
public class KitchenGameMultiplayer : NetworkBehaviour
{
    ...
    private void Awake()
    {
        ...
        playerName = PlayerPrefs.GetString(PLAYER_PREFS_PLAYER_NAME_MULTIPLAYER , "Player " + UnityEngine.Random.Range(10 , 1000));
    ...
    public void StartClient()
    {
        ...
        NetworkManager.Singleton.OnClientConnectedCallback += Singleton_Client_OnClientConnectedCallback;
        NetworkManager.Singleton.StartClient();
    }

    private void Singleton_Client_OnClientConnectedCallback(ulong clientId)
    {
        SetPlayerNameServerRpc(GetPlayerName());
        SetPlayerIdServerRpc(AuthenticationService.Instance.PlayerId);
    }
    ...
    [ServerRpc(RequireOwnership = false)]
    private void SpawnKitchenObjectServerRpc(int kitchenObjectSOIndex, NetworkObjectReference kitchenObjectParentsNetworkObjectParent)
    {
    ...
    public int GetKitcheObjectSOIndex(KitchenObjectsSO kitchenObjectSO)
    {
